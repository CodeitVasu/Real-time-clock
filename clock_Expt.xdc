...
set_property -dict { PACKAGE_PIN W13   IOSTANDARD LVCMOS33 } [get_ports { stop }]; #IO_L4N_T0_34 Sch=sw[2]
...
#LEDs
set_property -dict { PACKAGE_PIN M14   IOSTANDARD LVCMOS33 } [get_ports { sec }]; #IO_L23P_T3_35 Sch=led[0]
...
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { min[0] }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
